...
{
    gotoxy(15,8);
    printf("<--------: WELCOME TO STUDENT RECORD MANAGEMENT OF GANPAT UNIVERSITY :-------->");
    gotoxy(19,15);
...
void view()
{
    ...
    printf("<--------:VIEW RECORD:------->");
    gotoxy(10,5);
    printf("S.No   Name of Student       Mobile No   Roll No  Course      address");
    gotoxy(10,6);
    printf("--------------------------------------------------------------------");
    ...
    while(fread(&std,sizeof(std),1,fp) == 1){
        gotoxy(10,j);
        printf("%-7d%-22s%-12s%-9d%-12s%-12s",i,std.name,std.mobile,std.rollno,std.course,std.address);
        i++;
        j++;
    }
    fclose(fp);
